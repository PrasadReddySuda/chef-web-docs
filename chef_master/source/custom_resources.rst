...
As of Chef client 12.14, individual properties can be marked as `sensitive: true`, which suppresses the value of that property when exporting the resource's state. As of Chef client version 12.5, "resource attributes" are now known as "resource properties".
